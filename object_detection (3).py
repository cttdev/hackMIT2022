...
# image_url = "https://www.thatmutt.com/web/wp-content/uploads/2018/06/Car-rides-with-your-dog-and-baby.jpg"
# image_url = "https://www.parents.com/thmb/g6AEjbO9zGv0u41kyFkDMHozDRM=/1600x1200/smart/filters:no_upscale()/hannahmariah-c9b9376c3e7f4d1e8b80eebcf8ac89f8.jpg"
# image_url = "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQupOUyewXP6pJaYTi1AXuyDAnS1aNCMj9SPnguKsiQ&s"\
image_url = "/content/baby.png"
resized_image = resize_image(image_url, 1280, 856, True)
...
# module_handle = "/content/saved_model.pb"
detector = hub.load(module_handle).signatures['default']
# detector = tf.saved_model.load(module_handle)
...
def run_detector(detector, path):
  ...
  # classnames = result.get('detection_class_names')
  # labels = result.get('detection_class_labels')
  # print(list(zip(classnames, labels)))
...
result = run_detector(detector, resized_image)

# print(result)
# print(result)
classnames = result.get('detection_class_entities')
labels = result.get('detection_scores')
zipped = {key:value for key, value in zip(classnames, labels)}
# for pair in zipped.items():
#   print(pair)
# print(zipped)

#is there a baby or dog in the car
def isBabyOrDog(classnames, labels): 
  # zipped = {key:value for key, value in zip(classnames, labels)}
  zipped = [[key, value] for key, value in list(zip(classnames, labels))]
  for key, value in zipped:
    # print(key, value)
    if (b'Human' in key or b'Dog' in key) and value > 0.8:
      print(key, value)
      return True
...
labels = result.get('detection_scores')
# print(labels)
isBabyOrDog(classnames, labels)
# print(isBabyOrDog(result.get('detection_class_entities'), result.get('detection_scores')))